import { Lock, Mail, PhoneOutgoing, User } from "lucide-react";
...
const Signup = () => {
    ...
    const [formData, setFormData] = useState<SignupFormData>({
      ...
      console.log(errors,'thsi is the errors')
    return (
            ...
            >
                ...
                <div className="mb-10">
                    {/* {loading ? (
                          <button
                            disabled
                            className="w-full bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 flex items-center justify-center"
                          >
